...
save_dir_obj = '../data/{}/along/history/'.format(args.dataset)
...
all_rel_seq = sp.csr_matrix(([], ([], [])), shape=(num_e * num_e, num_r))
...
for tim in tqdm(all_times):
    ...
    all_tail_seq = all_tail_seq + tail_seq
    # relation history
    ...
    all_rel_seq = all_rel_seq + rel_seq
    sp.save_npz('../data/{}/along/history/tail_history_{}.npz'.format(args.dataset, tim), all_tail_seq)
    sp.save_npz('../data/{}/along/history/rel_history_{}.npz'.format(args.dataset, tim), rel_seq)
